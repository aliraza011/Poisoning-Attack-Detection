...
label_poisoning=to_categorical(randnums)
...
with plt.style.context('fivethirtyeight'):
    ...
    langs = ['Without data poisoning', 'with data poisoning (label Swapping)','with data poisoning (random labelfeature noise)']
    accuracy = [87,26,24]
...
svm = OneClassSVM(kernel='poly', gamma='scale', nu=0.3)
print(svm)
